...
* Notebook `Evaluate_Generated_Code_Using_Pass@1.ipynb` explains how the code generation capabilities of LLMs are evaluated. It loads the code generated by an LLM and uses the modified human-eval package to evaluate its quality by computing the Pass@1 score. Pass@5 and Pass@10 scores can also be evaluated.
